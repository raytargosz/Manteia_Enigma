...
namespace Pegasus
{
    ...
    public class PegasusManagerEditor : Editor
    {
        ...
        {
            Application.OpenURL("https://assetstore.unity.com/packages/tools/animation/pegasus-65397");
        }

        /// <summary>
        /// Show support site
        /// </summary>
        [MenuItem("GameObject/Pegasus/Pegasus Support Forum...", false, 41)]
        public static void ShowSupportSite()
        {
            Application.OpenURL("https://canopy.procedural-worlds.com/forums/forum/12-pegasus/");
        }
        ...
        {
            Application.OpenURL("https://canopy.procedural-worlds.com/library/tools/pegasus/39_tutorials/");
        }
